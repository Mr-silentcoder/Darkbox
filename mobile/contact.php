...
try {
    ...
    $mail->addAddress('');                             // Add a recipient-> add your email 
                                                       // Name is optional
...
?>  
<div><h4 style="color:#fff;margin:10px; text-align: center;font-weight: bold;">Contact</h4></div>
                <div class="playlist-wrap" style="height: 400px;">
     ...
     <form role="form" action="" method="post" style="margin: 10px 30px 20px 30px;"> 
       <?php
                        ...
                        <div class="form-group" style="text-align: left;"> 
                            <label for="formInput94" style="text-align: left; font-weight: bold;font-size: 16px;">Name</label>                             
